export const ptTextProjects = [
  {
    id: "toddler_and_nursery",
    projectSubtitle:
      "Um mergulho no fundo do mar - Projetos diversos na preservação ambiental",
    projectDescription: [
      "Os alunos terão a chance de explorar uma simulação de praia, onde poderão experimentar diferentes sensações. Além disso, aprenderão sobre os diferentes tipos de tartarugas.Uma mesa sensorial estará disponível para despertar a curiosidade das crianças. Também estão planejadas atividades interativas, como a sacola com a foto de uma água-viva. Outra atividade interativa envolverá um experimento com canudos.Essas atividades foram cuidadosamente planejadas para oferecer aos alunos uma experiência divertida e educativa na feira de ciências, incentivando seu interesse pela ciência e pelo mundo ao seu redor",
    ],
  },
  {
    id: "jk",
  ...
  {
    id: "year2",
    projectSubtitle: "Esportes Capixabas",
    projectDescription: [
      "Aprendendo sobre os esportes capixabas, o Year 2 criou uma “calçada da fama” especial, destacando atletas capixabas inspiradores. Os alunos aprenderam sobre suas conquistas e contribuições para o esporte.",
      "Exploraremos o basquete, mergulhando na história e evolução desse esporte emocionante.",
      "A exposição também dedica um tempo para entender como o vôlei é praticado nas Paraolimpíadas, destacando a inclusão e a importância da acessibilidade e exibe uma entrevista com estudantes e funcionários da escola sobre acessibilidade, incentivando a todos a refletirem sobre a importância de um ambiente inclusivo.",
    ],
  },
  {
    id: "year3",
  ...
  {
    id: "year5",
    projectSubtitle: "Empreendedorismo capixaba",
    projectDescription: [
      'O Year 5 criou uma empresa chamada “Re-imagine Funland" com o objetivo de criar brinquedos divertidos utilizando materiais reciclados.',
      'Os alunos aprenderam sobre sustentabilidade, reciclagem e reutilização, colocando sua imaginação em prática para transformar objetos em brinquedos incríveis, além de desenvolverem habilidades empreendedoras ao planejar, projetar e apresentar seus produtos.',
      "Também será exposto a arte do papel semente com uma interação que envolverá os visitantes.",
      "Além disso, também estará exposto a “docelandia”.",
    ],
  },
];

export const ptTextProjectsMap = new Map(
  ptTextProjects.map((el) => [el.id, el])
);
